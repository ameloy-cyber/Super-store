...
sheet = sheets.InteractiveSheet(df=top_10_sales_states)

# Sort the state_summary DataFrame by 'Profit' in descending order and display the top 10 rows
try:
    top_10_profit_states = state_summary.sort_values(by='Profit', ascending=False).head(10)

    print("Top 10 States by Profit:")
    display(top_10_profit_states)

except NameError:
    print("The DataFrame 'state_summary' was not found. Please ensure the cell grouping by state has been executed.")
except KeyError:
    print("The 'Profit' column was not found in the 'state_summary' DataFrame.")
except Exception as e:
    print(f"An error occurred: {e}")

# Group the DataFrame by 'Category' and calculate the average 'Shipping Duration'
try:
    # Ensure 'Shipping Duration' is in a format that can be averaged (e.g., days)
    # The difference of two datetimes results in a Timedelta object, which can be averaged directly.
    category_shipping_time = excel_df.groupby('Category')['Shipping Duration'].mean()

    # Display the resulting Series
    print("Average Estimated Arrival Time per Category:")
    display(category_shipping_time)

except NameError:
    print("The DataFrame 'excel_df' or the 'Shipping Duration' column was not found. Please ensure the necessary cells have been executed.")
except KeyError:
    print("The 'Category' column was not found in the DataFrame.")
except Exception as e:
    print(f"An error occurred: {e}")
